...
#ds_samples = BA9_samples + muscle_skeletal_samples + whole_blood_samples + liver_samples

rule MakeBfiles:
    input:
        expand(
        "/project2/mstephens/cfbuenabadn/gtex-stm/code/gtex-download-for-DS/Brain_Frontal_Cortex_BA9/bams/{IndID}.Aligned.sortedByCoord.out.patched.md.bam",
        IndID = BA9_samples
        ),
        expand(
        "/project2/mstephens/cfbuenabadn/gtex-stm/code/gtex-download-for-DS/Brain_Frontal_Cortex_BA9/bams/{IndID}.Aligned.sortedByCoord.out.patched.md.bam.bai",
        IndID = BA9_samples
        ),
        expand(
        "/project2/mstephens/cfbuenabadn/gtex-stm/code/gtex-download-for-DS/Muscle_Skeletal/bams/{IndID}.Aligned.sortedByCoord.out.patched.md.bam",
        IndID = muscle_skeletal_samples
        ),
        expand(
        "/project2/mstephens/cfbuenabadn/gtex-stm/code/gtex-download-for-DS/Muscle_Skeletal/bams/{IndID}.Aligned.sortedByCoord.out.patched.md.bam.bai",
        IndID = muscle_skeletal_samples
        ),
        expand(
        "/project2/mstephens/cfbuenabadn/gtex-stm/code/gtex-download-for-DS/Whole_Blood/bams/{IndID}.Aligned.sortedByCoord.out.patched.md.bam",
        IndID = whole_blood_samples
        ),
        expand(
        "/project2/mstephens/cfbuenabadn/gtex-stm/code/gtex-download-for-DS/Whole_Blood/bams/{IndID}.Aligned.sortedByCoord.out.patched.md.bam.bai",
        IndID = whole_blood_samples
        ),
        expand(
        "/project2/mstephens/cfbuenabadn/gtex-stm/code/gtex-download-for-DS/Liver/bams/{IndID}.Aligned.sortedByCoord.out.patched.md.bam",
        IndID = liver_samples
        ),
        expand(
        "/project2/mstephens/cfbuenabadn/gtex-stm/code/gtex-download-for-DS/Liver/bams/{IndID}.Aligned.sortedByCoord.out.patched.md.bam.bai",
        IndID = liver_samples
        ),
    output:
        expand("DifferentialSplicing/rMATS/bfiles/{group}.{n}b.txt", 
        group = rmats_group_list, n = ['3', '5', '100'])
    log:
